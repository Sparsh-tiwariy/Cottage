...
<body class="fontbody">
	...
	<div class="row">
		...
		<div class="large-8 columns blackblur fontgrey" style="padding-top:10px; color: white">
			<h3 style="color:white"><b>Guest Details</b>
				<hr class="line">
			</h3>
			<form action="insertandemail.php" method="post" onSubmit="return validateForm(this);">
				<div class="row">
					...
					<div class="large-6 columns">
						<label class="fontgrey">First Name*
					...
					<div class="large-6 columns">
						<label class="fontgrey">Last Name*
				...
				<div class="row">
					<div class="large-6 columns">
						<label class="fontgrey">Email Address*
				...
				<div class="row">
					<div class="large-6 columns">
						<label class="fontgrey">Address Line 1*
					...
					<div class="large-6 columns">
						<label class="fontgrey">Address Line 2
				...
				<div class="row">
					<div class="large-6 columns">
						<label class="fontgrey">Zip/Postcode*
				...
				<div class="row">
					<div class="large-12 columns">
						<label class="fontgrey">Special Requirements
